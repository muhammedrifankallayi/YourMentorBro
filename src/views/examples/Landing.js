...
function Landing() {
  ...
  // Scroll handler for muting YouTube videos
    ...
    youtubeRefs.forEach(ref => {
      if (ref.current) {
        ...
        try {
          ...
          if (!isVisible) {
            if (!url.searchParams.has('mute') || url.searchParams.get('mute') !== '1') {
          ...
          console.error("Error updating YouTube video URL:", e);
        }
      }
    });
  };
  ...
  <div  className="vid-wrapper"  >
    <iframe 
                ...
                width="360" 
                height="350" 
                src="https://www.youtube.com/embed/q83Kv6L2STs?si=MONQnYSzhSo3pmnf" 
...
<div  className="vid-wrapper"  >
  <iframe 
              ...
              width="300" 
              height="310" 
              src="https://www.youtube.com/embed/NHaTNA8c7s8?si=YrG_JjIn3kbHM0p5" 
              title="YouTube video player" 
              frameborder="0" 
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
              referrerpolicy="strict-origin-when-cross-origin" 
...
<Row  className="row-video" >
  ...
  {/* <iframe width="360" height="350" src="https://youtube.com/embed/tFtz7i3-9RM?si=OpABzOJrpJmgXgT4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe> */}
 
     <iframe  width="360" height="350"  ref={youtubeRefs[0]}
          src="https://youtube.com/embed/tFtz7i3-9RM?si=OpABzOJrpJmgXgT4"
 ...
 <iframe  width="360" height="350"  ref={youtubeRefs[0]}
          src="https://youtube.com/embed/VweJA6kwnbk?si=Wd8DUd819HEqB9-G"
  ...
  <iframe  width="360" height="350"  ref={youtubeRefs[1]}
          src="https://youtube.com/embed/T1PeVldiT2A?feature=share"
            frameborder="0" 
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
            allowfullscreen>
          </iframe>
  ...
  <Container className="pt-lg pb-300">
    ...
    <Row className="row-grid mt-5">
      <Col lg="4">
        ...
        <h5 className="text-white mt-3">Work at Your Own Place</h5>
